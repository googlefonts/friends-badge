...
if (typeof window !== 'undefined' && typeof document !== 'undefined') {
  var GoogleFontsBadge = {
    init: function(element) {
      ...
      badgeStyles.innerHTML = '.GoogleFontsBadge { transform: translateY(100%); position: -webkit-sticky; position: sticky; z-index: 9999; bottom: 0; width: 100%; transition: transform 0.2s; pointer-events: none; } .GoogleFontsBadge__down { transform: translateY(100%) } .GoogleFontsBadge__up { transform: translateY(0) } .GoogleFontsBadge-inner { background: #222; } .GoogleFontsBadge-inner svg { width: 136px; display: block; fill: rgba(255, 255, 255, 0.70); } @media (min-width: 1024px) { .GoogleFontsBadge { width: auto } .GoogleFontsBadge-inner { background: transparent; } .GoogleFontsBadge-inner svg { fill: rgba(0, 0, 0, 0.54); } .GoogleFontsBadge__down { transform: translateY(0); } }';
      ...
      var scrollValue = 0;
      var container = element ? element.parentNode : doc;
      var badgeParent = element || doc.body;
      badgeParent.style.position = 'relative';

      // Don’t just check if it’s undefined, because
      // the argument might be the body
      if (typeof element === 'undefined') {
        badgeContainer.style.position = 'fixed';
      }

      function appendBadgeStyles(styleContainer) {
        if (!doc.getElementById('js-GoogleFontsBadgeStyles')) {
          styleContainer.appendChild(badgeStyles);
        }
      }
      ...
      appendBadgeStyles(doc.head || badgeParent);
